(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VuetifyBundle"] = factory();
	else
		root["VuetifyBundle"] = factory();
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FormCollection__ = __webpack_require__(5);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "FormCollection", function() { return __WEBPACK_IMPORTED_MODULE_0__FormCollection__["a"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_es_uniqueId__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_es_isUndefined__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_es_isObject__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_es_isNumber__ = __webpack_require__(19);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    created: function created() {
        ...
        if (0 === this.currentItems.length) {
            ...
            try {
                for (var _iterator = this.currentItems[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var item = _step.value;

                    this.items.push({ item: item, key: Object(__WEBPACK_IMPORTED_MODULE_0_lodash_es_uniqueId__["a" /* default */])() });
                }
            } catch (err) {
    ...
    render: function render(h) {
        ...
        var allowDelete = this.items.length > this.minItems && this.allowDelete && this.$scopedSlots.deleteButton;

        var _loop = function _loop(index, _length) {
            var children = [],
                item = _this.items[index],
                key = void 0;

            if (Object(__WEBPACK_IMPORTED_MODULE_2_lodash_es_isObject__["a" /* default */])(item)) {
                children.push(item.item);
                key = item.key;
            } else {
                children.push(_this.$scopedSlots.prototype({ index: index, length: _length, $bus: $bus }));
                key = item;
            }
        ...
        for (var index = 0, _length = this.items.length; index < _length; ++index) {
            _loop(index, _length);
        }
        ...
        if (this.allowAdd) {
            ...
            if (this.$slots.addButton) {
                ...
                addBtn = this.$scopedSlots.addButton({ length: length, $bus: $bus });
            }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__toString_js__ = __webpack_require__(7);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseToString_js__ = __webpack_require__(8);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Symbol_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__arrayMap_js__ = __webpack_require__(12);
...
//# sourceMappingURL=vuetify-bundle.js.map